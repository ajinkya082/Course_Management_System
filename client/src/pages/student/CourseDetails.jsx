...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    items-start justify-between md:px-36 px-8 md:pt-32 pt-20 text-left">
        ...
        text-course-details-heading-samll font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          <p className='pt-4 md:text-base text-sm'
            dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }}></p>

          {/* {review and rating} */}
          <div className='flex itmes-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <div className='pt-8 text-gray-800'>
                ...
                <div key={index} className='border border-gray-300 bg-white mb-2
                  ...
                  <div className='flex items-center justify-between px-4 py-3
                    ...
                    <div className='flex items-center gap-2'>
                      <img className={`transform transition-transfrom ${openSections[index] ? 'rotate-180' : ''}`}
            ...
            <div className='py-30 text-sm md:text-default'>
...
md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
          ...
          <div className="p-5 px-4">
            ...
            <div className='pt-6'>
              <p className=',d:text-xl text-lg font-medium text-gray-800'>What's in the course?</p>
              <ul className='ml-4 pt-2 text-sm md:text-default list-disc
                  text-gray-500'>
                <li>Lifetime access with free updates.</li>
                <li>Step-bby-step, hands-on project guidance.</li>
