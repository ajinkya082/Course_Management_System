    ...
    mt-10'>
      ...
      border-white/30'>
          ...
          w-full'>
            ...
            <p className='mt-6 text-center md:text-left text-sm text-white/80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus architecto alias harum repellendus omnis! Praesentium aliquid maiores quasi.</p>
          </div>
          <div className='flex flex-col md:items-start items-center
          w-full'>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2026 @ Learnify All Right Reserved</p>
    </footer>
  )
}
